...
public class TeamServiceImpl implements TeamService{
    ...
    public JSONObject teamListOfAccessByUid(long uid) {
        ...
        try {
            ...
            List<TeamInfoVO> teamMembers = CastEntity.castEntity(list, TeamInfoVO.class);
            res.put("code", "200");
...
//测试上传
    ...
    @Override
    public JSONObject teamListByUserId(long uId) {
        JSONObject res = new JSONObject();
        try {
            List<Team> teamList = teamRepository.teamListByUserId(uId);
            res.put("data",teamList);
            res.put("code","200");
        }catch (Exception e){
            e.printStackTrace();
